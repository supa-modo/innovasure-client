...
const MpesaIcon: React.FC<MpesaIconProps> = ({
  width = 28,
  height = 28,
  className = "",
  variant = "default",
}) => {
  // Normalize variant: "green" is an alias for "default"
  const normalizedVariant = variant === "green" ? "default" : variant;

  // Determine colors based on variant
  const primaryColor = normalizedVariant === "white" ? "#FFFFFF" : "#2DB34E";
  const secondaryColor = normalizedVariant === "white" ? "#FFFFFF" : "#2CB34C";
  const accentColor = normalizedVariant === "white" ? "#FFFFFF" : "#18AF41";
