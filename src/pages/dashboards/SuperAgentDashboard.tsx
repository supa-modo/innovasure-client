    ...
    <DashboardLayout role="super_agent" user={user} onLogout={handleLogout}>
      <div className="space-y-6">
        ...
        <div className="card border-l-4 border-purple-600">
          <h1 className="text-2xl font-bold text-gray-900">Super-Agent Dashboard</h1>
          <p className="text-gray-600 mt-1">Welcome back, {user?.profile?.full_name || 'Super-Agent'}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="card bg-green-50 border border-green-200">
            <h3 className="text-sm font-medium text-green-900">Total Members</h3>
          ...
          <div className="card bg-purple-50 border border-purple-200">
            <h3 className="text-sm font-medium text-purple-900">Commission Balance</h3>
            <p className="text-3xl font-bold text-purple-700 mt-2">KSh 12,450</p>
          ...
          <div className="card bg-orange-50 border border-orange-200">
            ...
            <p className="text-xs text-orange-600 mt-1">Total premiums collected</p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-colors text-left">
              ...
              <p className="text-sm text-gray-600 mt-1">Add agent to your network</p>
            </button>
            ...
            <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-colors text-left">
              ...
              <p className="text-sm text-gray-600 mt-1">View earnings and payouts</p>
            </button>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {[
              { name: 'Agent John Doe', code: 'AGT001', members: 45, commission: 3250 },
              { name: 'Agent Jane Smith', code: 'AGT002', members: 38, commission: 2870 },
              { name: 'Agent Mike Johnson', code: 'AGT003', members: 32, commission: 2400 },
            ].map((agent) => (
              <div key={agent.code} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                  <p className="text-sm font-medium text-gray-900">{agent.name}</p>
                  <p className="text-xs text-gray-600">{agent.code} • {agent.members} members</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-bold text-purple-700">KSh {agent.commission.toLocaleString()}</p>
