    ...
    <DashboardLayout role="agent" user={user} onLogout={handleLogout}>
      <div className="space-y-6">
        ...
        <div className="card border-l-4 border-green-600">
          ...
          <p className="text-gray-600 mt-1">Welcome back, {user?.profile?.full_name || 'Agent'}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="card bg-green-50 border border-green-200">
            <h3 className="text-sm font-medium text-green-900">Active Policies</h3>
          ...
          <div className="card bg-orange-50 border border-orange-200">
            ...
            <p className="text-3xl font-bold text-orange-700 mt-2">KSh 12,800</p>
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors text-left">
              ...
              <p className="text-sm text-gray-600 mt-1">Add member to your portfolio</p>
            </button>

            <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors text-left">
              <div className="text-2xl mb-2">📋</div>
              <h3 className="font-medium text-gray-900">View My Members</h3>
              <p className="text-sm text-gray-600 mt-1">Manage member profiles</p>
            </button>

            <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors text-left">
              <div className="text-2xl mb-2">💰</div>
              <h3 className="font-medium text-gray-900">Commission Report</h3>
              <p className="text-sm text-gray-600 mt-1">View earnings history</p>
            </button>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {[
              { name: 'John Kamau', account: 'ACC001234', status: 'Active', premium: 20 },
              { name: 'Mary Wanjiku', account: 'ACC001235', status: 'Active', premium: 500 },
              { name: 'Peter Odhiambo', account: 'ACC001236', status: 'Pending KYC', premium: 20 },
            ].map((member) => (
              <div key={member.account} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-600 mt-1">KSh {member.premium}/period</p>
                </div>
              </div>
            ))}
          </div>
